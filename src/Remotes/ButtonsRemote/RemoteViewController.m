...
- (void) addButtons
{
    ...
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDOKNF.png") 
                      forState:UIControlStateNormal];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDOKFO.png") 
    ...
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDBackNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDBackFO.png") 
             forState:UIControlStateHighlighted];
    ...
    button2.tag = 2;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDEscNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDEscFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button2.tag = 15;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDVideoNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDVideoFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button2.tag = 3;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDUpNF.png") 
                      forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDUpFO.png") 
                      forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button2.tag = 4;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDDownNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDDownFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button2.tag = 5;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDRightNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDRightFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button2.tag = 6;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDLeftNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDLeftFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button.tag = 7;
    [button addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDPrevTrackNF.png") 
            forState:UIControlStateNormal];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDPrevTrackFO.png") 
            forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button];
    ...
    button2.tag = 8;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDPlayNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDPlayFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button.tag = 9;
    [button addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDNextTrackNF.png") 
            forState:UIControlStateNormal];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDNextTrackFO.png") 
            forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button];
    ...
    button2.tag = 10;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDStopNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDStopFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button.tag = 11;
    [button addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDSubtitlesNF.png") 
            forState:UIControlStateNormal];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDSubtitlesFO.png") 
            forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button];
    ...
    button2.tag = 12;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDInfoNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDInfoFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
    ...
    button.tag = 13;
    [button addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDOSDNF.png") 
            forState:UIControlStateNormal];
    [button setImage:TTIMAGE(@"bundle://buttons.bundle/OSDOSDFO.png") 
            forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button];
    ...
    button2.tag = 14;
    [button2 addTarget:self action:@selector(buttonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDMenuNF.png") 
             forState:UIControlStateNormal];
    [button2 setImage:TTIMAGE(@"bundle://buttons.bundle/OSDMenuFO.png") 
             forState:UIControlStateHighlighted];
    [_buttonsView addSubview:button2];
}
...
//                        initWithImage:TTIMAGE(@"bundle://buttons.bundle/detailsback.png")] autorelease];
//    _backgroundView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    ...
    _buttonsView = [[[TTView alloc] initWithFrame:TTNavigationFrame()] autorelease];
...
//    _cover.defaultImage = TTIMAGE(@"bundle://buttons.bundle/thumbnailNone.png");        
...
//    menu.view.hidden = TRUE;
    ...
    {
        if ([[XBMCStateListener sharedInstance].currentPlayers objectForKey:@"video"])
            [self updatePlayingInfo:[[XBMCStateListener sharedInstance].currentPlayers objectForKey:@"video"]];
        else if ([[XBMCStateListener sharedInstance].currentPlayers objectForKey:@"audio"])
            [self updatePlayingInfo:[[XBMCStateListener sharedInstance].currentPlayers objectForKey:@"audio"]];
    }
}
