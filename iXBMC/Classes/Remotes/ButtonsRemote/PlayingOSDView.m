...
//        UIImage *pausedImage= TTIMAGE(@"bundle://osd_button_paused.png");
//        _pausedOSD.image = [pausedImage stretchableImageWithLeftCapWidth:36 topCapHeight:3.0];
        _pausedOSD.image = TTIMAGE(@"bundle://osd_button_paused.png");
...
//        UIImage *timeImage= TTIMAGE(@"bundle://osd_button_progress.png");
//        _timeOSD.image = [timeImage stretchableImageWithLeftCapWidth:36.0 topCapHeight:0.0];
        _timeOSD.image = TTIMAGE(@"bundle://osd_button_progress.png");
