...
- (id) initWithEntity:(NSEntityDescription *)entity controllerTableView:(UITableView *)controllerTableView{
	...
	if(self)
    {
		...
		self.sortArray = [NSClassFromString([entity managedObjectClassName]) sorts];
		self.sortNames = [NSClassFromString([entity managedObjectClassName]) sortNames];
