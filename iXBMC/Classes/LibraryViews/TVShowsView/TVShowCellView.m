...
- (void)setItem:(TVShowTableItem *)item {
...
{
    if ([[result valueForKey:@"url"] isEqualToString:((TVShowTableItem*)_item).imageURL]
...
- (void)loadImage
{
	...
	else if (_item.imageURL && !_item.poster )
    {
		...
		//        NSInteger height = TTSTYLEVAR(TVShowssViewCellsMaxHeight);
